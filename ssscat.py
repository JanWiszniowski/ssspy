...
from core.utils import get_focal_mechanism, get_origin, get_hypocentral_distance
...
def fields_on_station(configuration, catalog):
    ...
    **Description required here**
    ...
    station_codes = [result['station_code'] for result in results]
    ...
    ax5.scatter(distances, amplitude_differences, color=colors, label=station_codes, marker='o')
